...
6. Create a database access key
    ...
    - Click “Save”fnAEV7dLwYAAQqerkumYQM4ttyvCqhePmo_H9cdM

7. Copy the database access key’s secret[fnAEV51M98AAQPLrjluu93c1ht4lmEQQe6Gb6Ejt]
...
8. Set your database access secret in your terminal environment
    ...
    fnAEV7WJt9AAQms6ZlUfc5cGerTeO9SZRDtDTp5K
    fnAEV7WTWtAAQvsebQuD0_DeffCxWGn7vIR82j-K

    ```bash 
    export FAUNADB_SERVER_SECRET=fnAEV7QkvJAAQ4yzJr8a7bCxjmX-brth_fTS77rC
    ```
